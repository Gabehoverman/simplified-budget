...
<footer class="pb-4 bg-primary-3 text-light mt-5" id="footer">
    <div class="container">
        <div class="row mb-5">
            <div class="col">
                <div class="push-top card card-body border-0 o-hidden mb-0 bg-primary text-light" style="margin-top: -149px">
                    <div
        ...
        <div class="row mb-5">
            <div class="col-6 col-lg-5 col-xl-4">
                <img src="/img/watermark.png" width="150">
            </div>
            <div class="col-6 col-lg-3 col-xl-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a href="/web/features"  class="nav-link">Features</a>
                    </li>
                    <li class="nav-item">
                        <a href="/web/pricing"  class="nav-link">Pricing</a>
                    </li>
                    <li class="nav-item">
                        <a href="/web" class="nav-link">Contact</a>
                    </li>
                </ul>
            </div>
            <div class="col-6 col-lg-3 col-xl-3">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a href="/web/disclaimer" class="nav-link">Disclaimer</a>
                    </li>
                    <li class="nav-item">
                        <a href="/web/privacy"  class="nav-link">Privacy Policy</a>
                    </li>
                    <li class="nav-item">
                        <a href="/web/terms"  class="nav-link">Terms of Service</a>
                    </li>
                    <li class="nav-item">
                        <a href="/web" class="nav-link">Blog</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="row justify-content-">
            <div class="col col-md-auto">
                <small class="text-muted">© <?= date('Y'); ?> Simplified Budget.
                </small>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="/leap/assets/js/clipboard.min.js"></script>
...
<script type="text/javascript" src="/leap/assets/js/svg-injector.umd.production.js"></script>
