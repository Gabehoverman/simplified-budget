<footer class="pb-4 bg-primary-3 text-light" id="footer">
    <div class="container">
        <div class="row mb-5">
            <div class="col">
                <div class="push-top card card-body border-0 o-hidden mb-0 bg-primary text-light" style="margin-top: -150px">
                    <div
                    ...
                    <div class="decoration layer-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="338" height="277" viewBox="0 0 338 277"
                            fill="none" class="injected-svg bg-primary-2"
                            data-src="assets/img/decorations/deco-blob-1.svg"
        ...
        <div class="row mb-5">
            <div class="col-6 col-lg-5 col-xl-4">
                <img src="{{ asset('img/watermark.png') }}" width="150">
            </div>
            <div class="col-6 col-lg-3 col-xl-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('web.features') }}"  class="nav-link">Features</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('web.pricing') }}"  class="nav-link">Pricing</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('web') }}" class="nav-link">Contact</a>
                    </li>
                </ul>
            </div>
            <div class="col-6 col-lg-3 col-xl-3">
        ...
        <div class="row justify-content-">
            <div class="col col-md-auto">
                <small class="text-muted">© {{ Carbon\Carbon::now()->format('Y') }} Simplified Budget.
                </small>
            </div>
        </div>
    </div>
...
<a href="https://leap.mediumra.re/home-mobile-app.html#" class="btn back-to-top btn-primary btn-round aos-init"
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
        ...
        data-src="assets/img/icons/theme/navigation/arrow-up.svg">
...
<script type="text/javascript" src="{{ asset('/leap/assets/js/jquery.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('/leap/assets/js/popper.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('/leap/assets/js/bootstrap.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('leap/assets/js/aos.js') }}"></script>
<!-- Clipboard (copies content from browser into OS clipboard) -->
<script type="text/javascript" src="{{ asset('/leap/assets/js/clipboard.min.js') }}"></script>
<!-- Fancybox (handles image and video lightbox and galleries) -->
<script type="text/javascript" src="{{ asset('/leap/assets/js/jquery.fancybox.min.js') }}"></script>
<!-- Flatpickr (calendar/date/time picker UI) -->
<script type="text/javascript" src="{{ asset('/leap/assets/js/flatpickr.min.js') }}"></script>
<!-- Flickity (handles touch enabled carousels and sliders) -->
<script type="text/javascript" src="{{ asset('/leap/assets/js/flickity.pkgd.min.js') }}"></script>
<!-- Ion rangeSlider (flexible and pretty range slider elements) -->
<script type="text/javascript" src="{{ asset('/leap/assets/js/ion.rangeSlider.min.js') }}"></script>
<!-- Isotope (masonry layouts and filtering) -->
<script type="text/javascript" src="{{ asset('/leap/assets/js/isotope.pkgd.min.js') }}"></script>
<!-- jarallax (parallax effect and video backgrounds) -->
<script type="text/javascript" src="{{ asset('/leap/assets/js/jarallax.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('/leap/assets/js/jarallax-video.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('/leap/assets/js/jarallax-element.min.js') }}"></script>
<!-- jQuery Countdown (displays countdown text to a specified date) -->
<script type="text/javascript" src="{{ asset('/leap/assets/js/jquery.countdown.min.js') }}"></script>
<!-- jQuery smartWizard facilitates steppable wizard content -->
<script type="text/javascript" src="{{ asset('/leap/assets/js/jquery.smartWizard.min.js') }}"></script>
<!-- Plyr (unified player for Video, Audio, Vimeo and Youtube) -->
<script type="text/javascript" src="{{ asset('/leap/assets/js/plyr.polyfilled.min.js') }}"></script>
<!-- Prism (displays formatted code boxes) -->
<script type="text/javascript" src="{{ asset('/leap/assets/js/prism.js') }}"></script>
<!-- ScrollMonitor (manages events for elements scrolling in and out of view) -->
<script type="text/javascript" src="{{ asset('/leap/assets/js/scrollMonitor.js') }}"></script>
<!-- Smooth scroll (animation to links in-page)-->
<script type="text/javascript" src="{{ asset('/leap/assets/js/smooth-scroll.polyfills.min.js') }}"></script>
<!-- SVGInjector (replaces img tags with SVG code to allow easy inclusion of SVGs with the benefit of inheriting colors and styles)-->
<script type="text/javascript" src="{{ asset('/leap/assets/js/svg-injector.umd.production.js') }}"></script>
<!-- TwitterFetcher (displays a feed of tweets from a specified account)-->
<script type="text/javascript" src="{{ asset('/leap/assets/js/twitterFetcher_min.js') }}"></script>
<!-- Typed text (animated typing effect)-->
<script type="text/javascript" src="{{ asset('/leap/assets/js/typed.min.js') }}"></script>
<!-- Required theme scripts (Do not remove) -->
<script type="text/javascript" src="{{ asset('/leap/assets/js/theme.js') }}"></script>
